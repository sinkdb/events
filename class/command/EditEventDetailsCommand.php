...
class EditEventDetailsCommand extends \events\Command {
	...
	function execute(CommandContext $context)
	{
		...
		$query = "UPDATE events_events set eventname = :event_name, eventlocation = :event_location, eventdate = :event_date, 
					ticketprices = :ticket_prices, ticketlocation = :ticket_location, 
					opentime = :open_time, starttime = :start_time, eventrestrictions = :event_restrictions, artistdetails = :artist_details,  
					imageurl = :image_url where id = :id";
		...
		$sth->execute(array('event_name'=>$event_name, 'event_location'=>$event_location, 'event_date'=>$event_date, 
							...
							'start_time'=>$start_time, 'event_restrictions'=>$event_restrictions, 'artist_details'=>$artist_details, 'id'=>$id, 'image_url'=>$image_url));
